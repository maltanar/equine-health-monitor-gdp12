/**************************************************************************//**
 * @file
 * @brief LED driver code for Energy Micro EFM32TG-STK3300 starter kit
 * @note
 *    The GPIO output pin Port D, pin 7, is also used for driving the
 *    USART used for Board Controller Communication
