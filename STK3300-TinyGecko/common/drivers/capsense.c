...
#define CAPSENSE_NUMOF_SLIDERS       4                          /**< Number of sliders */
#define CAPSENSE_ACMP_VDD_SCALE      LESENSE_ACMP_VDD_SCALE     /**< Upper voltage threshold */

#define CAPSENSE_SLIDER_PORT0        gpioPortC                  /**< Slider Port. GPIO Port C */
#define CAPSENSE_SLIDER0_PORT        CAPSENSE_SLIDER_PORT0      /**< Slider 0 Port. GPIO Port C */
#define CAPSENSE_SLIDER0_PIN         5UL                        /**< Slider 0 Pin 5 */
#define CAPSENSE_SLIDER1_PORT        CAPSENSE_SLIDER_PORT0      /**< Slider 1 Port. GPIO Port C */
#define CAPSENSE_SLIDER1_PIN         7UL                        /**< Slider 1 Pin 7 */
#define CAPSENSE_SLIDER2_PORT        CAPSENSE_SLIDER_PORT0      /**< Slider 2 Port. GPIO Port C */
#define CAPSENSE_SLIDER2_PIN         12UL                       /**< Slider 2 Pin 12 */
#define CAPSENSE_SLIDER3_PORT        CAPSENSE_SLIDER_PORT0      /**< Slider 3 Port. GPIO Port C */
#define CAPSENSE_SLIDER3_PIN         13UL                       /**< Slider 3 Pin 13 */
...
void CAPSENSE_setupLESENSE(bool sleep)
{
  ...
  if (init)
  {
    ...
    for (i = 0; i < CAPSENSE_NUMOF_SLIDERS; i++)
    {
...
void LESENSE_IRQHandler(void)
{
  ...
  if ((LESENSE_IF_CH5 | LESENSE_IF_CH7 | LESENSE_IF_CH12 | LESENSE_IF_CH13) &
      LESENSE_IntGetEnabled())
  {
    /* Clear flags. */
    LESENSE_IntClear(LESENSE_IF_CH5 | LESENSE_IF_CH7 | LESENSE_IF_CH12 | LESENSE_IF_CH13);
