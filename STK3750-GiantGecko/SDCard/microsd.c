...
/* CS Enable/Disable USART2, Location #0 */
#define CS_LOW() GPIO_PinOutClear(gpioPortC, 5);  /**< Chip Selection in SPI mode. Enable when card is selected. */
#define CS_HIGH() GPIO_PinOutSet(gpioPortC, 5);  /**< Chip Selection in SPI mode. Enable when card is deselected. */
...
#define cmuClock_spi cmuClock_USART2

#define enableMOSI()  GPIO_PinModeSet(gpioPortC, 2, gpioModePushPull, 0);  /* MOSI */
#define enableMISO() GPIO_PinModeSet(gpioPortC, 3, gpioModeInputPull, 1);  /* MISO */
#define enableCS() GPIO_PinModeSet(gpioPortC, 5, gpioModePushPull, 0);  /* CS */
#define enableClock() GPIO_PinModeSet(gpioPortC, 4, gpioModePushPull, 0);  /* Clock */
...
void MICROSD_init(void)
{
  ...
  /* Enabling clock to USART 2 */
  CMU_ClockEnable(cmuClock_spi, true);
...
void power_off(void)
{
  ...
  /* Disable USART2 */
  CMU_ClockEnable(cmuClock_spi, false);
